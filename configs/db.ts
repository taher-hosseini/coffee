...
const connectToDB = async () => {
    try {
        ...
        const mongoURI = "mongodb://localhost:27017/coffe" || process.env.MONGODB_URI || "mongodb+srv://taher:taher@cluster0.05owt1n.mongodb.net/coffe?retryWrites=true&w=majority&appName=Cluster0";
